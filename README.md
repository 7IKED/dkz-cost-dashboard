...
![Lines](https://img.shields.io/badge/Lines-1366-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-cost-dashboard.git

# Oeffnen
cd dkz-cost-dashboard
